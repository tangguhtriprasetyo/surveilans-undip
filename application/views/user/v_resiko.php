            ...
            <div class="card card-primary">
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  ...
                  <input type="radio" id="psbb" name="skor" value="0">
                  <label for="psbb">0</label>
                  <input type="radio" id="psbb" name="skor" value="1">
                  <label for="psbb">1</label>
                  <input type="radio" id="pkm" name="skor" value="2">
                  <label for="pkm">2</label>
                  <input type="radio" id="lockdown" name="skor" value="3">
                  <label for="lockdown">3</label>
                  <input type="radio" id="tidak" name="skor" value="4">
