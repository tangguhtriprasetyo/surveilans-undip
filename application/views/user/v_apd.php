                ...
                <div class="section-title" data-aos="fade-up">
                  ...
                  <div class="form-group">
                    <label for="Tenaga Kesehatan">16. Jumlah tenaga kesehatan yang terlibat dalam penanganan Covid-19</label><br>
                      ...
                      <input style="margin: 8px;" name="dokter" type="number" id="textbox" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox2" /> Petugas Laboran
                      <input style="margin: 8px;" name="laboran" type="number" id="textbox2" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox3" /> Perawat
                      <input style="margin: 8px;" name="perawat" type="number" id="textbox3" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox4" /> Driver Ambulance
                      <input style="margin: 8px;" name="driver" type="number" id="textbox4" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox5" /> Cleaning Service
                      <input style="margin: 8px;" name="cs" type="number" id="textbox5" placeholder="  Jumlah" disabled /> </br>
                  ...
                  <div class="form-group">
                    <label for="exampleInputNWilayah">17. Bagaimana ketersediaan APD di Instansi Anda dalam satu pekan ini, sebutkan</label><br>
                      ...
                      <input style="margin: 8px;" name="bedah" type="number" id="textbox6" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox7" /> Masker N95
                      <input style="margin: 8px;" name="n95" type="number" id="textbox7" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox8" /> Face Shield
                      <input style="margin: 8px;" name="faceshield" type="number" id="textbox8" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox9" /> Goggle
                      <input style="margin: 8px;" name="goggle" type="number" id="textbox9" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox10" /> Sarung Tangan Medis
                      <input style="margin: 8px;" name="sarungtangan" type="number" id="textbox10" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox11" /> Hazmat
                      <input style="margin: 8px;" name="hazmat" type="number" id="textbox11" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox12" /> Caps
                      <input style="margin: 8px;" name="boot" type="number" id="textbox12" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox13" /> Driver Ambulance
                      <input style="margin: 8px;" name="caps" type="number" id="textbox13" placeholder="  Jumlah" disabled /> </br>
                      
                      <input type="checkbox" id="checkbox14" /> Shoe Cover
                      <input style="margin: 8px;" name="cover" type="number" id="textbox14" placeholder="  Jumlah" disabled /> </br>
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" id="psbb" name="kondisi" value="Pernah">
                    <label for="psbb">Pernah</label><br>
                    <input type="radio" id="psbb" name="kondisi" value="Belum Pernah">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="bantuan" class="form-control" id="exampleInputNoHP" placeholder="Sebutkan">
                  </div>
